...
class accountSetup
{
    ...
    public function mo_epbr_display__tab_details(){
        ...
        if($option){
            ...
            if(get_option('mo_epbr_registration_status')=='Login User'){
                            ...
                            <div >
                                <table border="1" style="background-color:#FFFFFF; border:1px solid #CCCCCC; border-collapse: collapse; padding:0px 0px 0px 10px; margin:2px; width:85%">
                                    <tr>
                                        ...
                                        <td style="width:55%; padding: 10px;"><?php echo get_option('mo_epbr_admin_email_setup'); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:45%; padding: 10px;">Customer ID</td>
                                        <td style="width:55%; padding: 10px;"><?php echo get_option('mo_epbr_admin_customer_key'); ?></td>
                                    </tr>
                                </table>
                                </br>
